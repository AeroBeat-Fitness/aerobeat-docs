...
(a) for any code that a Contributor has removed from the Covered
    Software; or
...
3.6. Distribution of Meager Modifications

A Contributor may require You to distribute the work under the terms of
this License if You modify the work only by (a) renaming the file, (b)
reorganizing the directory structure, or (c) adding to or deleting from
the contents of the file a standard header or legal notice.
