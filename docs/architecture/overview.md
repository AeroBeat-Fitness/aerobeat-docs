...
To support community modding safely, we ban scripts in asset packs. All content (Skins, Songs, Environments) is loaded via strict Resource definitions, preventing Remote Code Execution (RCE) from malicious mods.