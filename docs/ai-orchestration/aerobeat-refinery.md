...
*   **Action:** Look up its license in your knowledge base (e.g., MPL 2.0).
...
*   **Rejection Message:** `REJECTED: License Violation. This PR attempts to import code from a GPL repository into an MPL repository, which is strictly forbidden.`

### 2. Style Guide Compliance
*   **Action:** Scan the `diff` for common style violations defined in `gastown-polecat.md`.
